...
image_dir='/home/lohith/Desktop/pyPro/faceRecognizer/demoImages/known'
for root, dirs, files in os.walk(image_dir):
    ...
    for file in files:
        ...
        enocding=face_recognition.face_encodings(person)[0]
        Encodings.append(enocding)
        Names.append(name)
print(Names)
...
image_dir='/home/lohith/Desktop/pyPro/faceRecognizer/demoImages/unknown'
for root, dirs, files in os.walk(image_dir):
    for file in files:
        print(root)
        print(file)
